...
row_min = int(input("What is the lowest row number? (type an integer, 0 to 30, larger numbers can break this): "))
row_max = int(input("What is the highest row number? (type an integer, 0 to 30): "))
column_min = int(input("What is the lowest column number? (type an integer, 0 to 30): "))
column_max = int(input("What is the highest column number? (type an integer, 0 to 30): "))
graph = "   |"
